...
> **⚠ 삭제 권한 — 커밋 전, 워킹 트리에 있다** (2026-09-06).
...
>
> **눈으로 안 본 것.** 화면을 안 봤다 — HTML 문자열까지만 봤고, 삭제 칸이 빈 행에서 표가
> 어떻게 보이는지는 확인 못 했다.
> **⚠ 1차는 커밋됐다** (`e472bdd` feat · `3272873` docs). 푸시는 안 했다.
>
> **2차 — 새 버전 올리기 금지 + 폴더 삭제 문구** (2026-09-07, **커밋 전**). 1차가 삭제만
...
>
> **`/code-review` 와 `/security-review` 는 1차까지만 돌았다** — 2차 변경은 안 거쳤다.
