...
describe('supersededDocumentIds', () => {
  ...
  it('폴더가 다르면 서로 비교하지 않아야 한다', () => {
    const rows: LatestCandidate[] = [
      { id: 'a1', folderId: 'health', updatedAt: at('2026-08-25T00:00:00Z') },
      { id: 'a2', folderId: 'health', updatedAt: at('2026-08-26T00:00:00Z') },
      { id: 'b1', folderId: 'login', updatedAt: at('2026-01-01T00:00:00Z') },
      { id: 'b2', folderId: 'login', updatedAt: at('2026-01-02T00:00:00Z') },
    ]
  ...
  it('미분류 문서는 서로 비교하지 않아야 한다', () => {
    ...
    const rows: LatestCandidate[] = [
      { id: 'meeting', folderId: null, updatedAt: at('2026-08-20T00:00:00Z') },
      { id: 'budget', folderId: null, updatedAt: at('2026-08-21T00:00:00Z') },
    ]
  ...
  it('미분류 문서가 폴더 안 문서의 판정을 흔들지 않아야 한다', () => {
    ...
    const rows: LatestCandidate[] = [
      { id: 'n1', folderId: null, updatedAt: at('2026-09-01T00:00:00Z') },
      { id: 'n2', folderId: null, updatedAt: at('2026-08-15T00:00:00Z') },
      { id: 'f1', folderId: 'health', updatedAt: at('2026-08-20T00:00:00Z') },
      { id: 'f2', folderId: 'health', updatedAt: at('2026-08-21T00:00:00Z') },
    ]
